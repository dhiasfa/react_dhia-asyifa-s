...
export const Form = () => {
    ...
    const handleSubmit = (event) => {
      ...
      const handleDelete = (id) => {  
       const konfirmasiDelete= window.confirm('Are you want to delete this data?');
          if(konfirmasiDelete){
        ...
        <table className="table table-striped ms-5" style={{width:1100}} >
          <thead>
            <tr>
              ...
              <th scope="col"  style={{width:150}}>Additional Desciption</th>
          ...
          <tbody id="list">
            ...
            <tr key={products.id}>
              ...
              <td className='d-flex'>
                <button className='btn btn-danger' onClick={() => handleDelete(products.id)}>Delete</button>
